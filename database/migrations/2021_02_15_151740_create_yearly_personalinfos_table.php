...
class CreateYearlyPersonalinfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('yearly_personalinfo', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('yearly_personalinfo');
    }
}
